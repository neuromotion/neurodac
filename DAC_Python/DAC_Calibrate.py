...
# Set calibration factor (max amplitude of data)
calFactor = 4.8 # mV
...
freq = numpy.array([100, 100, 100, 100, 100, 100, 100, 100]) # Frequency of each channel (Hz)
...
for channel in range(numChannels):
    data[:, channel] = (amp[channel]/calFactor)*numpy.sin(2*pi*freq[channel]*t)
